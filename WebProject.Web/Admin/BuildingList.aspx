<%@ Page Title="System" MasterPageFile="~/Admin/Site1.Master" Language="C#" AutoEventWireup="true" CodeBehind="BuildingList.aspx.cs" Inherits="WebProject.Web.Admin.BuildingList" %>
...
<div class="path">
    ...
    <tr>
        ...
        <td class="tdbg">                       
            ...
            <a href="/admin/BuildingEdit.aspx" class="btncss">Add</a>
        </td>
        <td class="tdbg">
        </td>
    </tr>
    ...
    <asp:BoundField DataField="BuildName" HeaderText="BuildName" ItemStyle-HorizontalAlign="Center"  /> 
    <asp:BoundField DataField="Address" HeaderText="Address" ItemStyle-HorizontalAlign="Center"  /> 
    <asp:BoundField DataField="lng" HeaderText="lng" ItemStyle-HorizontalAlign="Center"  /> 
    <asp:BoundField DataField="lat" HeaderText="lat" ItemStyle-HorizontalAlign="Center"  /> 
    <asp:BoundField DataField="AddDate" HeaderText="AddDate" ItemStyle-HorizontalAlign="Center"  /> 

                <asp:HyperLinkField HeaderText="Button" ControlStyle-Width="50" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="BuildingEdit.aspx?id={0}"
                    Text="Edit"  />
